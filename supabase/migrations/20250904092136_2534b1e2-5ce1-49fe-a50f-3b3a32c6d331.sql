-- Drop and recreate the tricks table without constraints
...
-- Create policy for anyone to view tricks
CREATE POLICY "Anyone can view tricks" ON tricks FOR SELECT USING (true);
...
('Touch / Target', 'Dog touches nose to hand or object.', 'Present target, reward nose touches. Add cue ''Touch.''', 1, 'Foundation', '{}', 1),
