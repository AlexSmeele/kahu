...
export default function GuideOnboarding() {
  ...
  return (
    <main className="content-frame bg-background flex flex-col h-full">
      {/* Header */}
      ...
      {/* Footer */}
      <div className="fixed bottom-0 left-0 right-0 bg-background/95 backdrop-blur-sm border-t p-4 z-20">
