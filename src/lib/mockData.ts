...
export const MOCK_DOG_TRICKS = [
  // Foundation training for Suki
  {
    ...
    proficiency_level: 'basic' as const,
    practice_contexts: [],
    basic_completed_at: '2025-01-01T12:00:00Z',
    generalized_completed_at: null,
    proofed_completed_at: null,
    last_practiced_at: '2025-01-01T12:00:00Z',
    trick: TRICK_PREPARE,
  },
  {
    ...
    proficiency_level: 'basic' as const,
    practice_contexts: [],
    basic_completed_at: '2025-01-05T10:00:00Z',
    generalized_completed_at: null,
    proofed_completed_at: null,
    last_practiced_at: '2025-01-05T10:00:00Z',
  ...
  },
  {
    ...
    updated_at: new Date().toISOString(),
    proficiency_level: 'basic' as const,
    practice_contexts: ['indoors'],
    basic_completed_at: null,
    generalized_completed_at: null,
    proofed_completed_at: null,
    last_practiced_at: '2025-01-03T10:00:00Z',
  ...
  },
  {
    ...
    updated_at: new Date().toISOString(),
    proficiency_level: 'basic' as const,
    practice_contexts: ['indoors', 'outdoors'],
    basic_completed_at: null,
    generalized_completed_at: null,
    proofed_completed_at: null,
    last_practiced_at: '2025-01-03T11:00:00Z',
  ...
  },
  {
    ...
    generalized_completed_at: null,
    proofed_completed_at: null,
    last_practiced_at: '2025-01-12T10:00:00Z',
...
export const MOCK_TROUBLESHOOTING_TOPICS = [
  {
    id: 'troubleshooting-topic-001',
    name: 'Understanding Behavior Problems',
    description: 'Before solving anything, owners should understand the "why"',
    icon: 'Brain',
    color: 'from-blue-500 to-blue-600',
    order: 1,
    created_at: new Date().toISOString(),
    subSessions: [
      {
        id: 'troubleshooting-sub-001-1',
        name: 'How dogs learn and unlearn behaviors',
        description: 'Understanding the learning process',
        instructions: 'Dogs learn through association and consequences. Behaviors that are rewarded increase, those that aren\'t decrease. Unlearning requires consistency, patience, and providing alternative behaviors. Punishment often creates fear without teaching what TO do.',
        estimated_time_weeks: 2,
        order: 1,
        created_at: new Date().toISOString(),
      },
      {
        id: 'troubleshooting-sub-001-2',
        name: 'The role of stress, fear, and frustration in behavior issues',
        description: 'Recognize emotional drivers of behavior',
        instructions: 'Many problem behaviors stem from stress, fear, or frustration. Signs include panting, pacing, whale eye, lip licking, yawning, avoiding eye contact. Address the emotional state, not just the behavior. Punishment increases stress and worsens problems.',
        estimated_time_weeks: 2,
        order: 2,
        created_at: new Date().toISOString(),
      },
      {
        id: 'troubleshooting-sub-001-3',
        name: 'Breed tendencies and realistic expectations',
        description: 'Set appropriate goals for your dog',
        instructions: 'Different breeds have different instincts and energy levels. Herding breeds may nip, terriers may dig, hounds may wander. Work with your dog\'s nature, not against it. Adjust expectations based on breed characteristics and individual temperament.',
        estimated_time_weeks: 1,
        order: 3,
        created_at: new Date().toISOString(),
      },
      {
        id: 'troubleshooting-sub-001-4',
        name: 'Common owner mistakes that reinforce bad habits',
        description: 'Avoid accidentally rewarding unwanted behaviors',
        instructions: 'Common mistakes: giving attention for barking, letting dog pull to interesting things, picking up when fearful, inconsistent rules, inadvertent reinforcement. Pay attention to what behavior you\'re actually rewarding. Timing is everything.',
        estimated_time_weeks: 2,
        order: 4,
        created_at: new Date().toISOString(),
      },
      {
        id: 'troubleshooting-sub-001-5',
        name: 'When to seek professional help',
        description: 'Know when to call in the experts',
        instructions: 'Seek help for: aggression, intense fear/anxiety, behavior not improving, feeling overwhelmed, safety concerns. Trainer for obedience issues, behaviorist for serious problems, vet to rule out medical causes. Don\'t wait until problems escalate.',
        estimated_time_weeks: 1,
        order: 5,
        created_at: new Date().toISOString(),
      },
  ...
  {
    id: 'troubleshooting-topic-002',
    name: 'Overexcitement & Hyperactivity',
    description: 'Manage and redirect high-energy behaviors',
    icon: 'Zap',
    color: 'from-orange-500 to-orange-600',
    order: 2,
    created_at: new Date().toISOString(),
    subSessions: [
      {
        id: 'troubleshooting-sub-002-1',
        name: 'Recognizing overstimulation vs. normal puppy energy',
        description: 'Identify when excitement becomes problematic',
        instructions: 'Normal energy: playful, can settle, responds to cues. Overstimulation: frantic, unable to focus, mouthing harder, ignoring cues, can\'t calm down. Puppies get overstimulated easily. Provide appropriate outlets and enforce naps.',
        estimated_time_weeks: 2,
        order: 1,
        created_at: new Date().toISOString(),
      },
      {
        id: 'troubleshooting-sub-002-2',
        name: 'Managing hyperactivity through structure and enrichment',
        description: 'Channel energy productively',
        instructions: 'Establish consistent daily routine. Provide mental challenges (training, puzzle toys, nose work). Physical exercise alone isn\'t enough. Teach impulse control. Practice calm behaviors. Balance stimulation with downtime.',
        estimated_time_weeks: 4,
        order: 2,
        created_at: new Date().toISOString(),
      },
      {
        id: 'troubleshooting-sub-002-3',
        name: 'Meeting mental and physical exercise needs',
        description: 'Tire the brain and body',
        instructions: 'A tired dog is a good dog. Provide age-appropriate exercise. Include mental work (training, scent games, food puzzles). 15 minutes of mental work = 1 hour of physical exercise. Quality over quantity. Avoid over-exercising young dogs.',
        estimated_time_weeks: 3,
        order: 3,
        created_at: new Date().toISOString(),
      },
      {
        id: 'troubleshooting-sub-002-4',
        name: 'Teaching calmness on cue',
        description: 'Train relaxation as a skill',
        instructions: 'Capture calm: reward when dog settles naturally. Use "settle" or "place" command. Practice relaxation protocol. Reward four paws on floor, lying down, quiet behavior. Make calmness valuable and rewarding.',
        estimated_time_weeks: 6,
        order: 4,
        created_at: new Date().toISOString(),
      },
      {
        id: 'troubleshooting-sub-002-5',
        name: 'Overexcitement around guests or other dogs',
        description: 'Manage greeting behaviors',
        instructions: 'Prepare before excitement starts. Practice calm greetings at distance. Gradually decrease distance. Reward all four paws on floor. Use management (gates, leashes) to prevent rehearsal. Teach alternative behaviors.',
        estimated_time_weeks: 8,
        order: 5,
        created_at: new Date().toISOString(),
      },
      {
        id: 'troubleshooting-sub-002-6',
        name: 'Redirecting high arousal behavior',
        description: 'Handle zoomies, jumping, mouthing',
        instructions: 'Zoomies: provide safe space, don\'t chase. Jumping: turn away, reward four on floor. Mouthing: redirect to toy, end play if continues. Teach impulse control games. Manage environment to prevent over-arousal.',
        estimated_time_weeks: 6,
        order: 6,
        created_at: new Date().toISOString(),
      },
  ...
  {
    id: 'troubleshooting-topic-003',
    name: 'Attention & Impulse Control Issues',
    description: 'Build focus and self-control',
    icon: 'Eye',
    color: 'from-purple-500 to-purple-600',
    order: 3,
    created_at: new Date().toISOString(),
    subSessions: [
      {
        id: 'troubleshooting-sub-003-1',
        name: 'Why your dog "doesn\'t listen"',
        description: 'Understanding attention problems',
        instructions: 'Common reasons: insufficient training, too many distractions, inconsistent cues, unreliable reinforcement history, competing motivations, unclear communication. Build foundation in low-distraction environment first.',
        estimated_time_weeks: 2,
        order: 1,
        created_at: new Date().toISOString(),
      },
      {
        id: 'troubleshooting-sub-003-2',
        name: 'Building focus and attention on you',
        description: 'Make yourself more interesting',
        instructions: 'Teach "look" or "watch me" cue. Reward eye contact heavily. Be unpredictable and exciting. Use high-value rewards. Practice name game. Build value for checking in with you. Start in quiet environments.',
        estimated_time_weeks: 4,
        order: 2,
        created_at: new Date().toISOString(),
      },
      {
        id: 'troubleshooting-sub-003-3',
        name: 'Teaching patience and self-control',
        description: 'Impulse control foundations',
        instructions: 'Practice wait before meals, doors, car. Teach leave it and take it. Use reward-based delay games. Build duration gradually. "Nothing in life is free" - calm behavior earns rewards. Practice daily.',
        estimated_time_weeks: 6,
        order: 3,
        created_at: new Date().toISOString(),
      },
      {
        id: 'troubleshooting-sub-003-4',
        name: 'Managing frustration in training sessions',
        description: 'Keep training positive and productive',
        instructions: 'Keep sessions short (5-10 minutes). End on success. Adjust difficulty if dog is frustrated. Use higher value rewards. Take breaks. If you\'re frustrated, dog feels it - stop and try later. Make it fun.',
        estimated_time_weeks: 3,
        order: 4,
        created_at: new Date().toISOString(),
      },
      {
        id: 'troubleshooting-sub-003-5',
        name: 'The "calmness before action" principle',
        description: 'Reward patience before excitement',
        instructions: 'Wait for sit before meals, calm before leash, settle before play. Dog must earn excitement through calmness. Consistent rule: no rewards for frantic behavior. Patience unlocks all good things.',
        estimated_time_weeks: 8,
        order: 5,
        created_at: new Date().toISOString(),
      },
  ...
  {
    id: 'troubleshooting-topic-004',
    name: 'Fear, Anxiety & Phobias',
    description: 'Help fearful dogs gain confidence',
    icon: 'Heart',
    color: 'from-pink-500 to-pink-600',
    order: 4,
    created_at: new Date().toISOString(),
    subSessions: [
      {
        id: 'troubleshooting-sub-004-1',
        name: 'Identifying fear vs. stress vs. anxiety',
        description: 'Recognize emotional states',
        instructions: 'Fear: response to specific trigger. Anxiety: generalized worry. Stress: response to pressure. Signs: trembling, hiding, tail tucked, ears back, panting, pacing, avoidance. Never punish fear - it makes it worse.',
        estimated_time_weeks: 1,
        order: 1,
        created_at: new Date().toISOString(),
      },
      {
        id: 'troubleshooting-sub-004-2',
        name: 'Common phobias',
        description: 'Address specific fears',
        instructions: 'Common: thunderstorms, fireworks, vacuum, vet visits, car rides, strangers, other dogs. Each requires specific desensitization plan. Don\'t force exposure. Go at dog\'s pace. Build positive associations.',
        estimated_time_weeks: 8,
        order: 2,
        created_at: new Date().toISOString(),
      },
      {
        id: 'troubleshooting-sub-004-3',
        name: 'Desensitization and counterconditioning basics',
        description: 'Change emotional response to triggers',
        instructions: 'Desensitization: gradual exposure at low intensity. Counterconditioning: pair trigger with something positive. Stay below threshold. Small steps. Patience required. Progress isn\'t linear. Don\'t rush.',
        estimated_time_weeks: 12,
        order: 3,
        created_at: new Date().toISOString(),
      },
      {
        id: 'troubleshooting-sub-004-4',
        name: 'Helping fearful dogs gain confidence',
        description: 'Build courage through success',
        instructions: 'Provide predictable routine. Celebrate small wins. Don\'t coddle or force. Let dog approach at their pace. Build confidence through training success. Provide safe spaces. Be patient and supportive.',
        estimated_time_weeks: 16,
        order: 4,
        created_at: new Date().toISOString(),
      },
      {
        id: 'troubleshooting-sub-004-5',
        name: 'Coping strategies for anxiety-prone dogs',
        description: 'Day-to-day management',
        instructions: 'Maintain consistent routine. Provide safe space (crate, room). Use calming aids (music, pheromones, anxiety wrap). Ensure adequate exercise. Teach relaxation. Manage environment to reduce stress.',
        estimated_time_weeks: 8,
        order: 5,
        created_at: new Date().toISOString(),
      },
      {
        id: 'troubleshooting-sub-004-6',
        name: 'Medication or supplements: when to ask your vet',
        description: 'Consider medical support',
        instructions: 'Consider for: severe anxiety, quality of life impacted, not responding to training, panic attacks, self-harm. Discuss with vet. Medication should support training, not replace it. Monitor response and adjust.',
        estimated_time_weeks: 2,
        order: 6,
        created_at: new Date().toISOString(),
      },
  ...
  {
    id: 'troubleshooting-topic-005',
    name: 'Separation Distress & Home-Alone Issues',
    description: 'Help dogs feel comfortable when alone',
    icon: 'Home',
    color: 'from-teal-500 to-teal-600',
    order: 5,
    created_at: new Date().toISOString(),
    subSessions: [
      {
        id: 'troubleshooting-sub-005-1',
        name: 'Understanding separation anxiety',
        description: 'Recognize true separation anxiety',
        instructions: 'True SA: panic when left alone. Signs: destruction near exits, drooling, panting, barking, house soiling, escape attempts. Starts immediately after departure. Different from boredom or insufficient exercise. Requires systematic treatment.',
        estimated_time_weeks: 2,
        order: 1,
        created_at: new Date().toISOString(),
      },
      {
        id: 'troubleshooting-sub-005-2',
        name: 'Early prevention for puppies',
        description: 'Build independence from the start',
        instructions: 'Practice short absences from day one. Use crate or pen for short periods. Don\'t make departures/arrivals big deal. Provide engaging activities when alone. Build positive association with alone time. Start young.',
        estimated_time_weeks: 4,
        order: 2,
        created_at: new Date().toISOString(),
      },
      {
        id: 'troubleshooting-sub-005-3',
        name: 'Step-by-step alone-time training',
        description: 'Systematic desensitization protocol',
        instructions: 'Start with seconds, not minutes. Practice departure cues without leaving. Leave for very short periods. Gradually increase duration. Stay below threshold. Multiple short sessions daily. Progress slowly and consistently.',
        estimated_time_weeks: 12,
        order: 3,
        created_at: new Date().toISOString(),
      },
      {
        id: 'troubleshooting-sub-005-4',
        name: 'Managing panic behaviors',
        description: 'Address barking, destruction, house soiling',
        instructions: 'Management while training: use daycare, pet sitter, take dog with you. Don\'t punish panic behaviors. Address underlying anxiety. Provide safe confinement. Use calming aids. Be patient - this takes time.',
        estimated_time_weeks: 8,
        order: 4,
        created_at: new Date().toISOString(),
      },
      {
        id: 'troubleshooting-sub-005-5',
        name: 'Tools and enrichment for independence',
        description: 'Keep dogs occupied when alone',
        instructions: 'Use food puzzles, frozen Kongs, treat-dispensing toys, chew items. Provide engaging activities. Tire dog before leaving. Leave TV/radio on. Use calming music. Rotate toys to maintain interest.',
        estimated_time_weeks: 4,
        order: 5,
        created_at: new Date().toISOString(),
      },
      {
        id: 'troubleshooting-sub-005-6',
        name: 'When to involve a professional behaviorist',
        description: 'Recognize when you need help',
        instructions: 'Seek help if: dog injuring self, severe destruction, quality of life impacted, not making progress, feeling overwhelmed. Separation anxiety is serious. Professional guidance greatly improves outcomes.',
        estimated_time_weeks: 1,
        order: 6,
        created_at: new Date().toISOString(),
      },
  ...
  {
    id: 'troubleshooting-topic-006',
    name: 'Dog-to-Dog Aggression & Reactivity',
    ...
    subSessions: [
      {
        id: 'troubleshooting-sub-006-1',
        name: 'Recognizing fear-based vs. resource-based aggression',
        description: 'Identify the root cause',
        instructions: 'Fear-based: defensive, wants distance, triggered by approach. Resource-based: guarding toy, food, person, space. Body language differs. Treatment differs. Understand motivation to address effectively.',
        estimated_time_weeks: 2,
        order: 1,
        created_at: new Date().toISOString(),
      },
      {
        id: 'troubleshooting-sub-006-2',
        name: 'Preventing leash reactivity',
        description: 'Stop leash aggression before it starts',
        instructions: 'Socialize properly when young. Keep leash loose. Reward calm behavior around other dogs. Don\'t let dog rehearse lunging. Increase distance from triggers. Practice attention exercises. Build positive associations.',
        estimated_time_weeks: 6,
        order: 2,
        created_at: new Date().toISOString(),
      },
      {
        id: 'troubleshooting-sub-006-3',
        name: 'Controlled introductions and parallel walking',
        description: 'Safe dog-to-dog meetings',
        instructions: 'Meet on neutral territory. Keep leashes loose. Parallel walk first. Allow brief sniff if both calm. Watch body language. Separate if tension rises. Multiple short positive encounters better than one long stressful one.',
        estimated_time_weeks: 4,
        order: 3,
        created_at: new Date().toISOString(),
      },
      {
        id: 'troubleshooting-sub-006-4',
        name: 'Counterconditioning for calm social behavior',
        description: 'Change emotional response to other dogs',
        instructions: 'Pair sight of other dogs with high-value treats. Work at distance where dog is under threshold. "Dog appears = good things happen." Gradually decrease distance. Reward any calm behavior. Patient, consistent practice.',
        estimated_time_weeks: 12,
        order: 4,
        created_at: new Date().toISOString(),
      },
      {
        id: 'troubleshooting-sub-006-5',
        name: 'Avoiding common triggers and mistakes',
        description: 'Prevent reactive episodes',
        instructions: 'Don\'t force interactions. Avoid on-leash greetings if reactive. Cross street to avoid triggers. Don\'t yell or punish reactions. Keep moving past triggers. Manage environment while training. Prevent rehearsal of reactive behavior.',
        estimated_time_weeks: 8,
        order: 5,
        created_at: new Date().toISOString(),
      },
  ...
  {
    id: 'troubleshooting-topic-007',
    name: 'Human-Directed Aggression',
    description: 'Address aggression toward people',
    icon: 'AlertTriangle',
    ...
    subSessions: [
      {
        id: 'troubleshooting-sub-007-1',
        name: 'Understanding fear and defensive aggression',
        description: 'Recognize defensive behavior',
        instructions: 'Fear aggression: "get away from me." Body: tense, ears back, tail tucked, growling, snapping. Triggered by approach, handling, cornering. Dog feels threatened. Never punish - increases fear. Build confidence and trust.',
        estimated_time_weeks: 3,
        order: 1,
        created_at: new Date().toISOString(),
      },
      {
        id: 'troubleshooting-sub-007-2',
        name: 'Guarding against strangers, family members, or visitors',
        description: 'Territorial aggression management',
        instructions: 'Management critical. Use gates, leashes, crates. Don\'t allow rehearsal. Systematic desensitization to visitors. Reward calm behavior. Have visitors toss treats. Build positive associations. Professional help strongly recommended.',
        estimated_time_weeks: 12,
        order: 2,
        created_at: new Date().toISOString(),
      },
      {
        id: 'troubleshooting-sub-007-3',
        name: 'Resource guarding of food, toys, or spaces',
        description: 'Possessive aggression solutions',
        instructions: 'Never punish guarding. Teach "trade" for valuable item. Approach = good things added, not taken away. Toss treats near dog with resource. Build trust. Manage environment. Remove triggers while training.',
        estimated_time_weeks: 8,
        order: 3,
        created_at: new Date().toISOString(),
      },
      {
        id: 'troubleshooting-sub-007-4',
        name: 'Handling reactivity toward children or specific people',
        description: 'Protect and rehabilitate carefully',
        instructions: 'Safety first - manage all interactions. Never leave unsupervised with children. Build distance. Use barriers. Systematic counterconditioning. Progress slowly. Professional help essential. Some dogs should not live with children.',
        estimated_time_weeks: 16,
        order: 4,
        created_at: new Date().toISOString(),
      },
      {
        id: 'troubleshooting-sub-007-5',
        name: 'Safety management plans while training',
        description: 'Keep everyone safe during behavior modification',
        instructions: 'Use muzzle training for safety. Manage all interactions. Use leashes, gates, separate spaces. Warn visitors. Have backup plan. Know dog\'s triggers. Prevention while building new behaviors. Safety never negotiable.',
        estimated_time_weeks: 8,
        order: 5,
        created_at: new Date().toISOString(),
      },
  ...
  {
    id: 'troubleshooting-topic-008',
    name: 'Barking Problems',
    description: 'Reduce excessive barking',
    icon: 'Volume2',
    color: 'from-yellow-500 to-yellow-600',
    order: 8,
    created_at: new Date().toISOString(),
    subSessions: [
      {
        id: 'troubleshooting-sub-008-1',
        name: 'Types of barking',
        description: 'Identify why your dog barks',
        instructions: 'Alert barking: responding to stimuli. Demand barking: wants something. Boredom: insufficient stimulation. Anxiety: separation or fear. Frustration: barrier frustration. Each type requires different approach. Understand cause to address effectively.',
        estimated_time_weeks: 2,
        order: 1,
        created_at: new Date().toISOString(),
      },
      {
        id: 'troubleshooting-sub-008-2',
        name: 'Identifying the root cause',
        description: 'Understand what triggers the barking',
        instructions: 'Keep bark diary: when, where, what triggered it, what happened after. Pattern emerges. Address underlying cause (boredom, anxiety, alerting). Simply stopping barking without addressing cause doesn\'t work long-term.',
        estimated_time_weeks: 2,
        order: 2,
        created_at: new Date().toISOString(),
      },
      {
        id: 'troubleshooting-sub-008-3',
        name: 'Teaching a "quiet" cue',
        description: 'Train an alternative to barking',
        instructions: 'Wait for natural pause in barking. Say "quiet" and reward silence. Build duration. Practice in low-distraction environment first. Don\'t yell "quiet" - dog thinks you\'re barking too. Reward what you want.',
        estimated_time_weeks: 4,
        order: 3,
        created_at: new Date().toISOString(),
      },
      {
        id: 'troubleshooting-sub-008-4',
        name: 'Reinforcing calm silence',
        description: 'Make quiet the default',
        instructions: 'Reward when dog is naturally quiet. "Catch" calm behavior. Ignore demand barking completely. Provide alternative behaviors (sit, place). Make quiet more rewarding than barking. Consistent reinforcement.',
        estimated_time_weeks: 6,
        order: 4,
        created_at: new Date().toISOString(),
      },
      {
        id: 'troubleshooting-sub-008-5',
        name: 'Environmental management and desensitization',
        description: 'Reduce triggers in the environment',
        instructions: 'Block visual triggers (close curtains). Reduce auditory triggers (white noise). Desensitize to common triggers gradually. Manage environment while training. Remove or reduce stimulation that causes barking.',
        estimated_time_weeks: 8,
        order: 5,
        created_at: new Date().toISOString(),
      },
      {
        id: 'troubleshooting-sub-008-6',
        name: 'Special programs: No-Bark Training Camp',
        description: 'Intensive structured desensitization',
        instructions: 'Comprehensive program addressing all barking triggers. Daily training sessions. Environmental management. Counterconditioning protocol. Progress tracking. Typically 4-8 weeks. Requires commitment but highly effective.',
        estimated_time_weeks: 8,
        order: 6,
        created_at: new Date().toISOString(),
      },
  ...
  {
    id: 'troubleshooting-topic-009',
    name: 'Destructive Behaviors & Chewing',
    description: 'Redirect inappropriate chewing',
    icon: 'Scissors',
    color: 'from-amber-500 to-amber-600',
    order: 9,
    created_at: new Date().toISOString(),
    subSessions: [
      {
        id: 'troubleshooting-sub-009-1',
        name: 'Why dogs chew',
        description: 'Understand the motivation',
        instructions: 'Normal for puppies (teething). Stress relief. Boredom. Lack of appropriate outlets. Separation anxiety. Exploration. Natural behavior that needs appropriate outlet. Address underlying cause.',
        estimated_time_weeks: 2,
        order: 1,
        created_at: new Date().toISOString(),
      },
      {
        id: 'troubleshooting-sub-009-2',
        name: 'Setting up appropriate chew zones',
        description: 'Provide acceptable alternatives',
        instructions: 'Provide variety of chew toys. Rotate to maintain interest. Use puzzle toys and food-dispensing items. Praise and reward when dog chews appropriate items. Make "legal" items more interesting than illegal ones.',
        estimated_time_weeks: 3,
        order: 2,
        created_at: new Date().toISOString(),
      },
      {
        id: 'troubleshooting-sub-009-3',
        name: 'Managing alone-time chewing',
        description: 'Prevent destructive chewing when unsupervised',
        instructions: 'Confine to safe area. Remove valuable items. Provide only safe chew items. Use frozen Kongs. Tire dog before leaving. Address any separation anxiety. Management prevents rehearsal of unwanted behavior.',
        estimated_time_weeks: 4,
        order: 3,
        created_at: new Date().toISOString(),
      },
      {
        id: 'troubleshooting-sub-009-4',
        name: 'Teaching "leave it" and "drop it"',
        description: 'Essential skills for redirection',
        instructions: 'Leave it: teach dog to ignore item. Drop it: release item from mouth. Start easy, gradually increase difficulty. Use high-value treats. Practice daily. These skills prevent many problems.',
        estimated_time_weeks: 4,
        order: 4,
        created_at: new Date().toISOString(),
      },
      {
        id: 'troubleshooting-sub-009-5',
        name: 'Redirecting to enrichment activities',
        description: 'Provide mental stimulation',
        instructions: 'Boredom often drives destruction. Provide puzzle feeders, training sessions, nose work, interactive toys. Mental work tires dogs. Rotate activities. Ensure adequate physical exercise too.',
        estimated_time_weeks: 6,
        order: 5,
        created_at: new Date().toISOString(),
      },
      {
        id: 'troubleshooting-sub-009-6',
        name: 'Destruction from separation anxiety or frustration',
        description: 'Address emotional causes',
        instructions: 'If destruction is near exits, only when alone, with other panic signs = separation anxiety. Requires SA-specific treatment. If from frustration: provide more exercise, training, enrichment. Address emotional state.',
        estimated_time_weeks: 8,
        order: 6,
        created_at: new Date().toISOString(),
      },
  ...
  {
    id: 'troubleshooting-topic-010',
    name: 'Nipping, Biting & Bite Inhibition',
    description: 'Teach gentle mouth and stop unwanted biting',
    icon: 'AlertOctagon',
    color: 'from-rose-500 to-rose-600',
    order: 10,
    created_at: new Date().toISOString(),
    subSessions: [
      {
        id: 'troubleshooting-sub-010-1',
        name: 'Puppy mouthing vs. aggressive biting',
        description: 'Recognize the difference',
        instructions: 'Puppy mouthing: playful, loose body, tail wagging, play bows. Aggressive: stiff body, intense stare, growling, hard bites, no play signals. Mouthing is normal but needs to be managed. Aggression needs professional help.',
        estimated_time_weeks: 1,
        order: 1,
        created_at: new Date().toISOString(),
      },
      {
        id: 'troubleshooting-sub-010-2',
        name: 'Teaching soft mouth and bite inhibition',
        description: 'Critical safety skill',
        instructions: 'Yelp and withdraw attention for hard bites. Reward gentle play. Gradually lower tolerance for pressure. Essential life skill. All dogs should learn bite inhibition before adult teeth. Can prevent serious injuries.',
        estimated_time_weeks: 6,
        order: 2,
        created_at: new Date().toISOString(),
      },
      {
        id: 'troubleshooting-sub-010-3',
        name: 'Redirecting to toys',
        description: 'Teach what TO bite',
        instructions: 'Have toy ready at all times. When puppy mouths you, redirect to toy. Praise for chewing toy. Make toys more exciting than hands. Consistent redirection. Every time, without exception.',
        estimated_time_weeks: 4,
        order: 3,
        created_at: new Date().toISOString(),
      },
      {
        id: 'troubleshooting-sub-010-4',
        name: 'Avoiding rough play that encourages biting',
        description: 'Set appropriate play rules',
        instructions: 'No rough wrestling or slap games. Teach calm play. Use toys, not hands, for play. If puppy gets too excited, end play. Teach that calm behavior gets play to continue. Set good habits early.',
        estimated_time_weeks: 3,
        order: 4,
        created_at: new Date().toISOString(),
      },
      {
        id: 'troubleshooting-sub-010-5',
        name: 'Handling sensitivity and fear-based nips',
        description: 'Build tolerance for touch',
        instructions: 'Go slow with sensitive areas. Pair handling with treats. Start brief, build duration. Never force. Respect dog\'s comfort level. For fear-based: address fear, don\'t punish. Build trust through gentle, positive handling.',
        estimated_time_weeks: 8,
        order: 5,
        created_at: new Date().toISOString(),
      },
      {
        id: 'troubleshooting-sub-010-6',
        name: 'Building calm handling tolerance',
        description: 'Prepare for vet, grooming, and daily care',
        instructions: 'Practice handling paws, ears, mouth daily. Use treats liberally. Keep sessions short. Build positive associations. Essential for vet visits, grooming, nail trims. Start young, but never too late.',
        estimated_time_weeks: 6,
        order: 6,
        created_at: new Date().toISOString(),
      },
  ...
  {
    id: 'troubleshooting-topic-011',
    name: 'Jumping Up & Overexcitement Greetings',
    description: 'Teach polite greeting behavior',
    icon: 'UserPlus',
    color: 'from-indigo-500 to-indigo-600',
    order: 11,
    created_at: new Date().toISOString(),
    subSessions: [
      {
        id: 'troubleshooting-sub-011-1',
        name: 'Why dogs jump',
        description: 'Understanding the behavior',
        instructions: 'Attention-seeking: jumping has been rewarded with attention. Excitement: can\'t contain enthusiasm. Natural greeting behavior (wants to reach face). Inadvertently reinforced by inconsistent responses.',
        estimated_time_weeks: 1,
        order: 1,
        created_at: new Date().toISOString(),
      },
      {
        id: 'troubleshooting-sub-011-2',
        name: 'Teaching four-on-the-floor greetings',
        description: 'Reward the behavior you want',
        instructions: 'Turn away when dog jumps. Reward immediately when all four paws are on floor. Practice with family first. Gradually increase difficulty. Consistency is critical. Everyone must follow same rule.',
        estimated_time_weeks: 4,
        order: 2,
        created_at: new Date().toISOString(),
      },
      {
        id: 'troubleshooting-sub-011-3',
        name: 'Reinforcing calm approaches',
        description: 'Proactive training',
        instructions: 'Practice greetings at different times. Reward calm sitting before greeting. Use "sit" cue as dog approaches. Release only when calm. Build self-control around excitement. Set dog up for success.',
        estimated_time_weeks: 6,
        order: 3,
        created_at: new Date().toISOString(),
      },
      {
        id: 'troubleshooting-sub-011-4',
        name: 'Managing guest greetings and door excitement',
        description: 'Handle high-arousal situations',
        instructions: 'Use management: leash, tether, gate. Have guests ignore dog until calm. Reward calm behavior heavily. Practice with patient friends. Keep dog away from door initially. Gradually build calmness skills.',
        estimated_time_weeks: 8,
        order: 4,
        created_at: new Date().toISOString(),
      },
      {
        id: 'troubleshooting-sub-011-5',
        name: 'Consistency across all family members',
        description: 'Everyone follows the same rules',
        instructions: 'Critical: inconsistency undermines training. If anyone rewards jumping, behavior continues. Train all family members. Warn guests. No exceptions. One reinforcement can undo weeks of training. United front essential.',
        estimated_time_weeks: 12,
        order: 5,
        created_at: new Date().toISOString(),
      },
  ...
  {
    id: 'troubleshooting-topic-012',
    name: 'House Training & Marking Issues',
    description: 'Resolve potty training problems',
    icon: 'Home',
    ...
    subSessions: [
      {
        id: 'troubleshooting-sub-012-1',
        name: 'Potty training troubleshooting',
        description: 'Fix common house training issues',
        instructions: 'Common issues: schedule too loose, reward timing off, insufficient supervision, medical issues. Solution: stricter schedule, immediately reward outdoor potty, supervise constantly, rule out medical causes. Patience required.',
        estimated_time_weeks: 4,
        order: 1,
        created_at: new Date().toISOString(),
      },
      {
        id: 'troubleshooting-sub-012-2',
        name: 'Recognizing the difference: excitement vs. anxiety urination',
        description: 'Identify submissive or excitement peeing',
        instructions: 'Excitement: during greetings, play, small amounts. Submissive: when approached, scolded, cowering. Not intentional. Never punish. Keep greetings calm. Build confidence. Address emotional state, not just behavior.',
        estimated_time_weeks: 3,
        order: 2,
        created_at: new Date().toISOString(),
      },
      {
        id: 'troubleshooting-sub-012-3',
        name: 'Extended potty training programs for difficult cases',
        description: 'Intensive retraining protocol',
        instructions: 'Back to basics. Treat like young puppy. Constant supervision or confinement. Very frequent outdoor trips. Reward every success. Clean accidents properly (enzyme cleaner). Keep detailed log. Gradual increase in freedom.',
        estimated_time_weeks: 8,
        order: 3,
        created_at: new Date().toISOString(),
      },
      {
        id: 'troubleshooting-sub-012-4',
        name: 'Managing territorial marking indoors',
        description: 'Stop marking behavior',
        instructions: 'Usually intact males but can be any dog. Neutering often helps. Belly bands for management. Interrupt marking. Reward outdoor marking. Clean marked spots thoroughly. Block access to favorite spots. Medical check if sudden onset.',
        estimated_time_weeks: 6,
        order: 4,
        created_at: new Date().toISOString(),
      },
      {
        id: 'troubleshooting-sub-012-5',
        name: 'Medical causes for accidents',
        description: 'Rule out health issues',
        instructions: 'Sudden house soiling can indicate: UTI, bladder stones, kidney issues, diabetes, cognitive decline, incontinence. Always consult vet for sudden changes or continued accidents despite training. Don\'t assume behavioral.',
        estimated_time_weeks: 1,
        order: 5,
        created_at: new Date().toISOString(),
      },
      {
        id: 'troubleshooting-sub-012-6',
        name: 'Crate and schedule management',
        description: 'Structure for success',
        instructions: 'Proper crate size (can stand, turn, lie down). Appropriate duration for age. Regular schedule: morning, after meals, after play, before bed. Set timer. Be consistent. Crate helps teach bladder control.',
        estimated_time_weeks: 6,
        order: 6,
        created_at: new Date().toISOString(),
      },
  ...
  {
    id: 'troubleshooting-topic-013',
    name: 'Recall & Off-Leash Reliability Problems',
    description: 'Build a bulletproof recall',
    icon: 'Navigation',
    color: 'from-cyan-500 to-cyan-600',
    order: 13,
    created_at: new Date().toISOString(),
    subSessions: [
      {
        id: 'troubleshooting-sub-013-1',
        name: 'Why recall fails',
        description: 'Understanding common problems',
        instructions: 'Competing motivations more rewarding. Weak reinforcement history. Inconsistent practice. Only called for negative things. Used too early in distracting environment. Poor timing of rewards. Need to rebuild from foundation.',
        estimated_time_weeks: 2,
        order: 1,
        created_at: new Date().toISOString(),
      },
      {
        id: 'troubleshooting-sub-013-2',
        name: 'Building a reliable recall step-by-step',
        description: 'Progressive training protocol',
        instructions: 'Start indoors, low distraction. Use highest value treats. Call only when sure dog will come. Reward generously every time. Gradually add distance and distraction. Never call for something negative. Make coming to you the best thing ever.',
        estimated_time_weeks: 12,
        order: 2,
        created_at: new Date().toISOString(),
      },
      {
        id: 'troubleshooting-sub-013-3',
        name: 'Using long lines and safe practice areas',
        description: 'Train safely with controlled freedom',
        instructions: 'Use 15-30ft long line for practice. Find safely fenced areas. Don\'t practice in dangerous areas. Long line provides safety while building reliability. Gradually fade leash as reliability improves.',
        estimated_time_weeks: 8,
        order: 3,
        created_at: new Date().toISOString(),
      },
      {
        id: 'troubleshooting-sub-013-4',
        name: 'Games for reinforcing recall',
        description: 'Make recall fun and rewarding',
        instructions: 'Hide and seek. Recall races with family. Surprise recalls during play. Chase games (you run away). Reward jackpots randomly. Keep it unpredictable and exciting. More fun = more reliable.',
        estimated_time_weeks: 6,
        order: 4,
        created_at: new Date().toISOString(),
      },
      {
        id: 'troubleshooting-sub-013-5',
        name: 'Managing distractions and proofing cues',
        description: 'Build reliability in real world',
        instructions: 'Start with mild distractions. Gradually increase difficulty. Practice near other dogs, people, squirrels. Use different locations. Random rewards keep it strong. Never progress faster than dog is ready.',
        estimated_time_weeks: 16,
        order: 5,
        created_at: new Date().toISOString(),
      },
      {
        id: 'troubleshooting-sub-013-6',
        name: 'Emergency recall cue training',
        description: 'Special cue for critical situations',
        instructions: 'Use different word than regular recall. Train with ONLY highest value rewards. Never use unless emergency. Practice rarely but maintain. Last resort for dangerous situations. Can be literal lifesaver.',
        estimated_time_weeks: 8,
        order: 6,
        created_at: new Date().toISOString(),
      },
  ...
  {
    id: 'troubleshooting-topic-014',
    name: 'Leash Pulling & Walk Frustration',
    description: 'Achieve pleasant, relaxed walks',
    icon: 'Anchor',
    ...
    subSessions: [
      {
        id: 'troubleshooting-sub-014-1',
        name: 'Why dogs pull',
        description: 'Understanding the motivation',
        instructions: 'Dogs walk faster than humans. Pulling has been reinforced (gets dog where they want to go). Excitement. High energy. Natural pace conflict. You must make NOT pulling more rewarding than pulling.',
        estimated_time_weeks: 1,
        order: 1,
        created_at: new Date().toISOString(),
      },
      {
        id: 'troubleshooting-sub-014-2',
        name: 'Equipment overview',
        description: 'Choose appropriate tools',
        instructions: 'Front-clip harness: discourages pulling. Back-clip: easier pulling. Head halter: control but requires conditioning. No-pull harnesses: various styles. Flat collar: fine for trained dogs. Never use choke or prong without professional guidance.',
        estimated_time_weeks: 1,
        order: 2,
        created_at: new Date().toISOString(),
      },
      {
        id: 'troubleshooting-sub-014-3',
        name: 'Teaching loose leash basics',
        description: 'Foundation loose leash walking',
        instructions: 'Stop moving when dog pulls. Resume when leash is slack. "Be a tree." Reward position by your side. Use high-value treats. Start in boring area. Short sessions. Consistent rule: pulling never works.',
        estimated_time_weeks: 8,
        order: 3,
        created_at: new Date().toISOString(),
      },
      {
        id: 'troubleshooting-sub-014-4',
        name: 'Managing arousal and anticipation before walks',
        description: 'Calm before the storm',
        instructions: 'Don\'t leash excited dog. Wait for calm to put on leash. Calm before going out door. If dog is frantic before walk even starts, they can\'t be calm during walk. Teach calmness unlocks walk.',
        estimated_time_weeks: 4,
        order: 4,
        created_at: new Date().toISOString(),
      },
      {
        id: 'troubleshooting-sub-014-5',
        name: 'Dealing with reactivity while walking',
        description: 'Handle leash reactions',
        instructions: 'Increase distance from triggers. Teach "watch me" or "focus" cue. Reward calm behavior around triggers. Use counterconditioning. Don\'t force approach to scary things. Manage environment while building new responses.',
        estimated_time_weeks: 12,
        order: 5,
        created_at: new Date().toISOString(),
      },
      {
        id: 'troubleshooting-sub-014-6',
        name: 'Advanced leash skills for high-energy dogs',
        description: 'Special techniques for strong pullers',
        instructions: 'Provide adequate exercise before walks. Practice direction changes. Use "no more pulling" intensive program. Consider dog sports as outlet. Mental work before walk. Ensure physical needs are met.',
        estimated_time_weeks: 12,
        order: 6,
        created_at: new Date().toISOString(),
      },
  ...
  {
    id: 'troubleshooting-topic-015',
    name: 'Submission & Low Confidence',
    description: 'Build confidence in fearful dogs',
    icon: 'TrendingUp',
    color: 'from-emerald-500 to-emerald-600',
    order: 15,
    created_at: new Date().toISOString(),
    subSessions: [
      {
        id: 'troubleshooting-sub-015-1',
        name: 'Recognizing excessive submission or appeasement',
        description: 'Identify over-submissive behavior',
        instructions: 'Signs: belly up immediately, cowering, submissive urination, avoiding eye contact, lip licking, yawning, excessive lowered body. Not necessarily abuse - may be temperament. Needs confidence building, not more submission.',
        estimated_time_weeks: 2,
        order: 1,
        created_at: new Date().toISOString(),
      },
      {
        id: 'troubleshooting-sub-015-2',
        name: 'Building confidence through predictable routines',
        description: 'Create security through consistency',
        instructions: 'Maintain consistent daily schedule. Predictable responses to behaviors. Safe spaces dog can retreat to. Routine reduces anxiety. Dog learns what to expect. Predictability builds confidence.',
        estimated_time_weeks: 4,
        order: 2,
        created_at: new Date().toISOString(),
      },
      {
        id: 'troubleshooting-sub-015-3',
        name: 'Gentle leadership and trust-based training',
        description: 'Lead without intimidation',
        instructions: 'Use positive reinforcement only. Never use punishment or corrections. Let dog make choices when safe. Respect fear responses. Build trust through gentle, patient training. Confidence grows from success, not force.',
        estimated_time_weeks: 8,
        order: 3,
        created_at: new Date().toISOString(),
      },
      {
        id: 'troubleshooting-sub-015-4',
        name: 'Avoiding intimidation or punishment',
        description: 'Protect fragile confidence',
        instructions: 'No physical corrections. No yelling. No intimidation. Alpha rolls and dominance theory harmful for submissive dogs. These dogs need encouragement, not discipline. Punishment destroys confidence completely.',
        estimated_time_weeks: 2,
        order: 4,
        created_at: new Date().toISOString(),
      },
      {
        id: 'troubleshooting-sub-015-5',
        name: 'Confidence-building games and exercises',
        description: 'Activities that build courage',
        instructions: 'Nose work builds confidence naturally. Trick training creates success. Agility obstacles (at own pace). Puzzle toys. Let dog problem solve. Celebrate every small win. Success breeds confidence.',
        estimated_time_weeks: 12,
        order: 5,
        created_at: new Date().toISOString(),
      },
  ...
  {
    id: 'troubleshooting-topic-016',
    name: 'Resource Guarding & Possessiveness',
    description: 'Safely address guarding behaviors',
    icon: 'Shield',
    ...
    subSessions: [
      {
        id: 'troubleshooting-sub-016-1',
        name: 'Understanding guarding behavior',
        description: 'Normal but needs addressing',
        instructions: 'Natural instinct to protect resources. Can be food, toys, space, person. Ranges from mild tension to serious aggression. Early intervention critical. Never punish - makes worse. Management and training needed.',
        estimated_time_weeks: 2,
        order: 1,
        created_at: new Date().toISOString(),
      },
      {
        id: 'troubleshooting-sub-016-2',
        name: 'Early prevention in puppies',
        description: 'Stop guarding before it starts',
        instructions: 'Handle puppy during meals (add good things to bowl). Practice trade games. Touch while eating. Make human approach mean good things. Prevention much easier than treatment. Start from day one.',
        estimated_time_weeks: 4,
        order: 2,
        created_at: new Date().toISOString(),
      },
      {
        id: 'troubleshooting-sub-016-3',
        name: 'Teaching trade and "leave it"',
        description: 'Give to get better',
        instructions: 'Trade for something better, never just take. "Leave it" for prevention. Dog learns giving up item gets better reward. Builds trust that giving up resources is good. Must be fair trade.',
        estimated_time_weeks: 6,
        order: 3,
        created_at: new Date().toISOString(),
      },
      {
        id: 'troubleshooting-sub-016-4',
        name: 'Counterconditioning to approach during meals or play',
        description: 'Change emotional response to approach',
        instructions: 'Walk by at distance, toss high-value treat. Gradually get closer. Human approach = better food appears. Never take food away during this training. Building positive association with approach.',
        estimated_time_weeks: 12,
        order: 4,
        created_at: new Date().toISOString(),
      },
      {
        id: 'troubleshooting-sub-016-5',
        name: 'Safety and management strategies',
        description: 'Prevent bites while training',
        instructions: 'Feed in separate area from other pets and children. Don\'t approach during meals if guarding. Remove high-value items when guests present. Management prevents rehearsal and keeps everyone safe.',
        estimated_time_weeks: 8,
        order: 5,
        created_at: new Date().toISOString(),
      },
  ...
  {
    id: 'troubleshooting-topic-017',
    name: 'Special Situations & Environment-Based Issues',
    description: 'Navigate transitions and environmental challenges',
    icon: 'MapPin',
    color: 'from-violet-500 to-violet-600',
    order: 17,
    created_at: new Date().toISOString(),
    subSessions: [
      {
        id: 'troubleshooting-sub-017-1',
        name: 'Trouble adjusting after a move or schedule change',
        description: 'Help dogs adapt to change',
        instructions: 'Maintain routine as much as possible. Familiar items in new space. Extra patience during transition. Expect temporary regression. Re-establish house training. Give time to adjust. Usually settles in 2-4 weeks.',
        estimated_time_weeks: 4,
        order: 1,
        created_at: new Date().toISOString(),
      },
      {
        id: 'troubleshooting-sub-017-2',
        name: 'Multi-dog household conflicts',
        description: 'Manage inter-dog relationships',
        instructions: 'Ensure adequate resources (multiple water bowls, beds, toys). Feed separately. Monitor play. Break up mounting/bullying. Provide individual attention. Some dogs incompatible. Seek help for serious fighting.',
        estimated_time_weeks: 8,
        order: 2,
        created_at: new Date().toISOString(),
      },
      {
        id: 'troubleshooting-sub-017-3',
        name: 'Introducing a baby or new pet',
        description: 'Smooth introductions',
        instructions: 'Baby: prep before arrival, associate baby with good things, never leave unsupervised, maintain dog\'s routine. New pet: neutral territory introduction, separate resources, supervised interactions, gradual integration.',
        estimated_time_weeks: 8,
        order: 3,
        created_at: new Date().toISOString(),
      },
      {
        id: 'troubleshooting-sub-017-4',
        name: 'Seasonal behavior shifts',
        description: 'Adapt to weather and seasonal changes',
        instructions: 'Some dogs more anxious in winter (less exercise). Storm anxiety worsens. Heat cycles affect behavior. Adjust exercise and enrichment. Provide adequate mental stimulation when outdoor time reduced. Be flexible.',
        estimated_time_weeks: 4,
        order: 4,
        created_at: new Date().toISOString(),
      },
      {
        id: 'troubleshooting-sub-017-5',
        name: 'Travel and transport stress',
        description: 'Reduce travel anxiety',
        instructions: 'Gradual car conditioning. Short trips to fun places. Secured travel crate or harness. Familiar items with dog. Break up long trips. Some dogs need medication for severe anxiety. Consult vet.',
        estimated_time_weeks: 6,
        order: 5,
        created_at: new Date().toISOString(),
      },
  ...
  {
    id: 'troubleshooting-topic-018',
    name: 'Advanced Troubleshooting Programs',
    description: 'Intensive protocols for persistent problems',
    icon: 'Award',
    color: 'from-fuchsia-500 to-fuchsia-600',
    order: 18,
    created_at: new Date().toISOString(),
    subSessions: [
      {
        id: 'troubleshooting-sub-018-1',
        name: '"No More Pulling" intensive leash manners plan',
        description: 'Structured loose leash walking program',
        instructions: 'Comprehensive 12-week program. Daily training sessions. Equipment setup. Progressive exercises. Environmental management. Tracking progress. Requires commitment but produces reliable loose leash walking.',
        estimated_time_weeks: 12,
        order: 1,
        created_at: new Date().toISOString(),
      },
      {
        id: 'troubleshooting-sub-018-2',
        name: '"Extended Potty Training" plan for regressions',
        description: 'Intensive house training reset',
        instructions: 'Back to basics complete protocol. Constant supervision or confinement. Hourly outdoor trips. Detailed tracking. Gradual freedom increase. Addresses all house training failures. Typically 8-12 weeks.',
        estimated_time_weeks: 12,
        order: 2,
        created_at: new Date().toISOString(),
      },
      {
        id: 'troubleshooting-sub-018-3',
        name: '"No-Bark Camp" structured desensitization schedule',
        description: 'Comprehensive barking reduction program',
        instructions: 'Identify all triggers. Environmental management. Counterconditioning protocol. Teaching quiet cue. Reinforcing silence. Progress tracking. Addresses all types of barking. 6-8 week intensive program.',
        estimated_time_weeks: 8,
        order: 3,
        created_at: new Date().toISOString(),
      },
      {
        id: 'troubleshooting-sub-018-4',
        name: '"Calm Home" environment setup guide',
        description: 'Create low-stress living space',
        instructions: 'Environmental audit. Reduce stimulation sources. Create calm zones. Establish routines. Management strategies. Enrichment balance. Overall stress reduction plan. Changes entire household dynamic.',
        estimated_time_weeks: 4,
        order: 4,
        created_at: new Date().toISOString(),
      },
      {
        id: 'troubleshooting-sub-018-5',
        name: '"Confidence Rebuild" for fearful or traumatized rescues',
        description: 'Comprehensive confidence building program',
        instructions: 'Gradual exposure protocol. Confidence building exercises. Trust development. Positive associations. Patient progression. Celebrates small wins. Specially designed for fear cases. Long-term program (16+ weeks).',
        estimated_time_weeks: 16,
        order: 5,
        created_at: new Date().toISOString(),
      },
  ...
  {
    id: 'troubleshooting-topic-019',
    name: 'When to Get Professional Help',
    description: 'Recognize when to call in the experts',
    icon: 'Users',
    color: 'from-red-500 to-red-600',
    order: 19,
    created_at: new Date().toISOString(),
    subSessions: [
      {
        id: 'troubleshooting-sub-019-1',
        name: 'Red flags for serious aggression or anxiety',
        description: 'Signs you need immediate help',
        instructions: 'Red flags: bite history, intense aggression, severe anxiety affecting quality of life, self-harm, inability to be left alone, escalating behavior, fear of family members. Don\'t wait - seek help immediately.',
        estimated_time_weeks: 1,
        order: 1,
        created_at: new Date().toISOString(),
      },
      {
        id: 'troubleshooting-sub-019-2',
        name: 'Choosing the right professional',
        description: 'Trainer vs. behaviorist vs. vet',
        instructions: 'Trainer: basic obedience, manners. Veterinary behaviorist: serious aggression, severe anxiety, medication needs. Certified behavior consultant: problem behaviors. Vet: rule out medical causes. Choose appropriate professional for problem.',
        estimated_time_weeks: 1,
        order: 2,
        created_at: new Date().toISOString(),
      },
      {
        id: 'troubleshooting-sub-019-3',
        name: 'How to prepare for a consultation',
        description: 'Make the most of professional help',
        instructions: 'Document behavior (video helpful). Track triggers and frequency. List what you\'ve tried. Medical history. Complete questionnaires thoroughly. Be honest about all behaviors. More information helps professional help you better.',
        estimated_time_weeks: 1,
        order: 3,
        created_at: new Date().toISOString(),
      },
      {
        id: 'troubleshooting-sub-019-4',
        name: 'What progress should look like',
        description: 'Set realistic expectations',
        instructions: 'Progress is gradual, not linear. Expect ups and downs. Serious problems take months, not weeks. Small improvements are real progress. Consistency essential. Follow plan completely. If no progress after several weeks, discuss with professional.',
        estimated_time_weeks: 2,
        order: 4,
        created_at: new Date().toISOString(),
      },
      {
        id: 'troubleshooting-sub-019-5',
        name: 'Realistic timelines for change',
        description: 'Understanding the commitment needed',
        instructions: 'Minor issues: 4-8 weeks. Moderate problems: 3-6 months. Serious issues: 6-12+ months. Some behaviors need lifelong management. Quick fixes don\'t exist for real problems. Patience and consistency required.',
        estimated_time_weeks: 2,
        order: 5,
        created_at: new Date().toISOString(),
      },
  ...
  {
    id: 'troubleshooting-topic-020',
    name: 'Long-Term Maintenance & Prevention',
    description: 'Keep good behavior consistent over time',
    icon: 'RefreshCw',
    color: 'from-lime-500 to-lime-600',
    order: 20,
    created_at: new Date().toISOString(),
    subSessions: [
      {
        id: 'troubleshooting-sub-020-1',
        name: 'Keeping training sharp',
        description: 'Maintain learned behaviors',
        instructions: 'Practice cues regularly. Random reinforcement maintains behavior. Short training sessions ongoing. Use cues in real life. Don\'t assume training is "done." Maintenance practice prevents regression.',
        estimated_time_weeks: 52,
        order: 1,
        created_at: new Date().toISOString(),
      },
      {
        id: 'troubleshooting-sub-020-2',
        name: 'Preventing regression',
        description: 'Avoid backsliding',
        instructions: 'Consistent rules always. Don\'t get complacent. Address small issues before they become big. Maintain management strategies. Continue rewarding good behavior. Prevention easier than re-training.',
        estimated_time_weeks: 52,
        order: 2,
        created_at: new Date().toISOString(),
      },
      {
        id: 'troubleshooting-sub-020-3',
        name: 'Ongoing enrichment and mental health',
        description: 'Maintain quality of life',
        instructions: 'Continue providing mental stimulation. Rotate enrichment activities. Regular exercise. Social opportunities. Maintain routine. Monitor stress levels. Preventive mental health care prevents problems.',
        estimated_time_weeks: 52,
        order: 3,
        created_at: new Date().toISOString(),
      },
      {
        id: 'troubleshooting-sub-020-4',
        name: 'Balancing freedom and structure',
        description: 'Find the right balance for your dog',
        instructions: 'Too much freedom can lead to problems. Too much restriction causes frustration. Find balance appropriate for your dog. Adjust as dog matures. Some dogs need more structure than others. Know your dog.',
        estimated_time_weeks: 12,
        order: 4,
        created_at: new Date().toISOString(),
      },
      {
        id: 'troubleshooting-sub-020-5',
        name: 'Knowing your dog\'s limits',
        description: 'Accept and work with limitations',
        instructions: 'Some behaviors can\'t be completely eliminated. Some dogs will always need management. Not all dogs can handle all situations. Know and respect your dog\'s limits. Management is not failure - it\'s responsible ownership.',
        estimated_time_weeks: 4,
        order: 5,
        created_at: new Date().toISOString(),
      },
